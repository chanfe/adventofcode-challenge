...
def value_vaild(key,value):
    try:
        ...
        if key == 'ecl':
            x = re.findall('(amb|blu|brn|gry|grn|hzl|oth)', value)
            if x:
                return True
            else:
                return False
...
# key = 'pid'
# value = "0000000002"
# print(value_vaild(key,value))

# print(question1('../files/test.txt'))
# print(question2('../files/test.txt'))
print(question1('../files/day4_input.txt'))
