    ...
    with open(file) as f:
        ...
        for code in content:
            ...
            for instuction in code:
                if instuction == "D" and y < 2:
                    y+=1
                elif instuction == "U" and y > 0:
                    y-=1
                elif instuction == "R" and x < 2:
                    x+=1
                elif instuction == "L" and x > 0:
                    x-=1
            answer += keypad[y][x]
        return answer
...
def question2(file):
    ...
    with open(file) as f:
        ...
        for code in content:
            for instuction in code:
                if instuction == "D" and y < 4:
                    if keypad[y+1][x] != 'NULL':
                        y+=1
                elif instuction == "U" and y > 0:
                    if keypad[y-1][x] != 'NULL':
                        y-=1
                elif instuction == "R" and x < 4:
